#*********************************************************************
# content   = saves work and publishes files                            #This Header is taken from Plex-master,
#             executes other scripts on PUBLISH (task in file name)     # to emphasis the importance of it.
# version   = 0.1.1
# date      = 2019-10-06
#
